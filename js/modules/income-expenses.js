...
import { getEl, showMessage, clearMessage, setLoading, formatCurrency, formatDate, getCurrentSchoolId, openPrintWindow, logStaffActivity } from './utils.js';
...
window.ieDeleteRecord = async function(id) {
  ...
  try {
    ...
    try { await logStaffActivity('Deleted income/expenditure record', { entityType: 'incomeexpense', entityDetails: `Record ${id}` }); } catch (e) { /* noop */ }
