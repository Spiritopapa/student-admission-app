...
window.previewDebtorsList = async function() {
  ...
  try { await logStaffActivity('Generated debtors list (preview)', { entityType: 'debtors' }); } catch (e) { /* noop */ }
};
...
window.printDebtorsListDirect = async function() {
  ...
  try { await logStaffActivity('Generated debtors list', { entityType: 'debtors' }); } catch (e) { console.warn(e); }
};
